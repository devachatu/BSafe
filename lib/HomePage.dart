...
class _HomePageState extends State<HomePage>
  ...
  getUserLocation() async {
    ...
    HomePage.currentLocation = await locateUser();
    setState(() {
      _center = LatLng(HomePage.currentLocation.latitude,
          HomePage.currentLocation.longitude);
    });
                  ...
                  children: <Widget>[
                    ...
                    isLoading
                        ...
                        : Container(
                            ...
                            width: 200,
                            child:
                                Text(first.addressLine.substring(0, 46) + "..",
                                    textAlign: TextAlign.center,
                                    style: TextStyle(
